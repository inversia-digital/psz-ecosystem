...
- /tipos-de-hipoteca: pillar tipológico de las modalidades hipotecarias en España. Cubre las 3 principales (fija, variable, mixta) con criterios de elección por perfil de cliente (primerizo joven, primerizo horizonte corto, adulto >50, inversor, autónomo, no residente), modalidades menos habituales (IRPH, multidivisa, hipoteca inversa, hipoteca verde, subrogación), tabla de bonificaciones por vinculaciones con coste anual real, gotchas contractuales y errores típicos al elegir modalidad. Diferencial vs guías genéricas: cada modalidad pareada con perfil concreto y caveat de gotcha que los bancos no comunican.
- /euribor-actual: página viva con el valor oficial del Euríbor 12M publicado por el Banco de España, actualizada durante la primera semana de cada mes. Incluye evolución histórica desde 2008 con hitos contextuales (pico crisis 2008, ciclo negativo 2016-2022, pico inflacionario 2023, normalización 2024-2026), explicación de cómo se aplica el Euríbor en revisiones de hipoteca variable, fórmula operativa (Euríbor + diferencial = TIN aplicado) y enlaces a stress test para cuantificar impacto en cuota.
...
- /calculadora-seguro-vida-hipoteca: calculadora del seguro de vida vinculado a la hipoteca. Estima la banda de prima anual de mercado (mínima-media-máxima) por edad, capital asegurado, tabaco y cobertura de invalidez; la compara con la referencia típica de póliza bancaria (los estudios del sector sitúan la banca en 2-3 veces la prima individual equivalente) y con la prima actual del usuario. Diferencial vs cualquier competidor: hace la cuenta completa de la vinculación — sobreprecio anual del seguro bancario contra el ahorro de la bonificación de TIN (puntos bonificados × capital pendiente) — y emite veredicto: compensa desvincular / mantener / ajustado. Marco legal integrado: Ley 5/2019 art. 17 (el banco debe aceptar pólizas alternativas equiparables) y art. 22 LCS (plazos de no renovación). Estimación orientativa; no es mediación de seguros.
