...
export const SOBRE_MI = {
  ...
  bio: {
    ...
    paragraphs: [
      ...
      'Más allá del crédito hipotecario, también me ocupo del diseño de estructuras societarias: holdings nacionales (tipo Inversiones Palantio, mi propio holding) que separan operativa de patrimonio, y estructuras internacionales como LLC americanas para inversión transfronteriza, facturación en divisas y protección patrimonial. Lo aprendí operando para mí mismo y ahora lo aplico para clientes con perfil similar al mío.',
