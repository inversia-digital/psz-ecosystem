      ...
      <Container size="xl">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-x-8 gap-y-10 mb-12">
          ...
          <div className="text-sm space-y-2">
            ...
            <p>
              <a href="/hipoteca-inversor" className="text-paper/70 hover:text-paper no-underline">
                Hipoteca inversor
              </a>
            </p>
            <p>
              <a href="/hipoteca-no-residentes" className="text-paper/70 hover:text-paper no-underline">
                Hipoteca no residentes
              </a>
            </p>
            <p>
              <a href="/hipoteca-autonomos" className="text-paper/70 hover:text-paper no-underline">
                Hipoteca autónomos
              </a>
            </p>
            <p>
