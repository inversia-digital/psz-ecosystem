...
export const alt = 'Calculadora de hipoteca profesional · Toño Palacios broker nº E242'
export const size = { width: 1200, height: 630 }
export const contentType = 'image/png'

/**
 * OG image dinámica para /calculadora-hipoteca.
 * Generada via @vercel/og (Next.js ImageResponse). Se renderiza una sola
 * vez por deploy y queda cacheada en CDN.
 *
 * Paleta: navy-900 #0F1B2D + gold-400 #C8A852 + paper #FFFFFF.
 * Identidad: nombre Toño Palacios + credencial E242 + dominio psz.es.
 */
    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
          ...
          >
            Cuota, intereses, LTV y ratio de esfuerzo · Avisos automáticos sobre rangos críticos
            de scoring bancario.
          </div>
        </div>

        {/* Footer: autor + credenciales */}
        <div
          style={{
            display: 'flex',
            alignItems: 'center',
