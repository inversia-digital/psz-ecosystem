...
export const alt =
  'Stress test Euríbor · ¿Cuánto subirá tu hipoteca si sube el Euríbor? · Toño Palacios broker E242'
    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
          ...
          >
            Si el Euríbor sube X puntos, ¿cuánto subirá tu cuota mensual? · 5 escenarios paralelos
            · Avisos sobre ratio de esfuerzo proyectado.
          </div>
        </div>
